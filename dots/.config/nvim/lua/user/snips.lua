...
ls.add_snippets("tex", {
    s("graph", {
        t("\\begin{figure}[h]\n\\centering\n\\begin{tikzpicture}\n\\begin{axis}["),
        t("width=0.8\\textwidth, height=0.6\\textwidth,\nxlabel={X-axis},\nylabel={Y-axis},\ngrid=both,\nlegend pos=outer north east\n]"),
...
ls.add_snippets("tex", {
    s("table", {
        t("\\begin{table}[h]\n\\centering\n\\begin{tabular}{"),
        i(1, "lccc"), t("}\n\\toprule\n"),
        i(2, "Header"), t(" & "), i(3, "Header 2"), t(" & "), i(4, "Header 3"), t(" \\\\\n\\midrule\n"),
        i(5, "Row 1"), t(" & "), i(6, "Data"), t(" & "), i(7, "Data 2"), t(" \\\\\n"),
